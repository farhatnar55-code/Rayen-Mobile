...
import 'package:rayen_mobile/features/training/presentation/screens/trainer_sessions_screen.dart';
...
class _TrainerDashboardScreenState extends State<TrainerDashboardScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<TrainingProvider>().loadSessionsByTrainer(uid);
      if (uid.isNotEmpty) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: _buildModernDrawer(user?.fullName ?? 'Formateur', user?.photoUrl),
      body: Stack(
        children: [
          ...
          PageView(
            ...
            children: [
              ...
              TrainerSessionsScreen(trainerId: user?.uid ?? ''),
              const ProfileScreen(),
            ],
          ),
        ],
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  _buildDrawerItem(Icons.event_note_rounded, 'Mes Sessions', 1),
                  _buildDrawerItem(Icons.person_rounded, 'Profil', 2),
                ],
              ),
            ),
...
class _TrainerHomeTab extends StatelessWidget {
  ...
  const _TrainerHomeTab({required this.name, required this.trainerId});
      ...
      builder: (_, provider, __) {
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _buildGreeting(name, sessions.length, totalStudents),
                ...
                ...upcoming
                    ...
                    .map(
                      (s) => Padding(
                        ...
                        child: _UpcomingSessionCard(session: s),
                      ),
                    ),
            ],
          ),
  ...
  Widget _buildGreeting(String name, int sessionsCount, int studentsCount) {
    return _ModernCard(
...
class _UpcomingSessionCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final daysUntil = session.sessionDate.difference(DateTime.now()).inDays;

    return _SessionCard(session: session, daysUntil: daysUntil);
  }
}
...
class _SessionCard extends StatefulWidget {
  ...
  const _SessionCard({required this.session, required this.daysUntil});
          ...
          children: [
            Row(
              children: [
                ...
                _DaysChip(days: widget.daysUntil),
              ],
            ),
            ...
            if (widget.session.meetingLink != null) ...[
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () => _launchLink(widget.session.meetingLink!),
